...
public class Database {
	...
	public Database() {
		...
		Paper couplingAndCoesion = new Paper(1, "Coupling and Coesion", joao,
				modularity);
		Paper designPatterns = new Paper(2, "Design Patterns", beatriz,
				softwareReuse);
		Paper aspectJ = new Paper(3, "AspectJ", suzana,
				aspectOrientedProgramming);
		Paper featureModel = new Paper(4, "Feature Model", natasha,
				softwareProductLines);
		Paper architectureRecovery = new Paper(5, "Architecture Recovery",
				pedro, softwareArchitecture);
		Paper functionalTesting = new Paper(6, "Funcional Testing", carlos,
				softwareTesting);
		Paper cots = new Paper(7, "COTs", beatriz, softwareReuse);
		Paper pointcut = new Paper(8, "Pointcut", suzana,
				aspectOrientedProgramming);
		Paper productDerivation = new Paper(9, "Product Derivation", natasha,
				softwareProductLines);
		Paper architectureComformance = new Paper(10,
				"Architecture Comformance", pedro, softwareArchitecture);
		Paper structuralTesting = new Paper(11, "Structural Testing", carlos,
				softwareTesting);
		...
		Conference icse = new Conference("ICSE", membersCommitteeICSE,
				unallocatedPapersICSE);
		// ------------------------------------------------------------------------------------------------------
		...
		Conference fse = new Conference("FSE", membersCommitteeFSE,
				unallocatedPapersFSE);
		// ------------------------------------------------------------------------------------------------------
		...
		Conference sbes = new Conference("SBES", membersCommitteeSBES,
				unallocatedPapersSBES);
		// -------------------------------------------------------------------------------------------------------
